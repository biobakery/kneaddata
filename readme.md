...
Kneaddata will **not** trim the overrepresented sequences `by default`.

It is **highly reccommended** for shotgun raw sequences to `--run-trim-repetitive` for trimming the overrepresented sequences generated by FASTQC reports.
...
trimmomatic arguments:
  ...
  --trimmomatic-options TRIMMOMATIC_OPTIONS
    ...
    --run-trim-repetitive      Option for trimming repetitive sequences  
